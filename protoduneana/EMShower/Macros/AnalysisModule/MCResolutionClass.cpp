#include "MCResolutionClass.h"

// === Constructor ===
MCResolution::MCResolution(std::string filePath, float electronEnergy) : MC(filePath, electronEnergy) {
...
// === Methods ===
void MCResolution::ComputeResolution(int iR1, int iR2, int iHeight) {
    // This method will contain the logic to compute the Resolution for a given geometry based on the MC data
...
void MCResolution::ComputeResolutionError(int iR1, int iR2, int iHeight) {
    // This method will contain the logic to compute the Resolution error for a given geometry based on the MC data
...
void MCResolution::Draw2DMap(int iR1, std::string savePath) {
...
void MCResolution::DrawMin(int iR1, std::string savePath) {
...
void MCResolution::DrawMinFinal(std::string savePathPlot, std::string savePathData) {
